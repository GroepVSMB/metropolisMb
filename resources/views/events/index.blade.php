                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="p-3 text-xs text-gray-500">
                                        @foreach($event->impacts as $impact)
                                            <div>{{ $impact->category->name }}: <span class="{{ $impact->livability_adjustment > 0 ? 'text-green-600' : 'text-red-600' }} font-bold">{{ $impact->livability_adjustment > 0 ? '+' : '' }}{{ $impact->livability_adjustment }}</span></div>
                                        @endforeach
                                    </td>
