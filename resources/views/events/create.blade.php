                ...
                <form action="{{ route('events.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                        <div>
                            ...
                            <input type="text" name="name" required class="w-full border-gray-300 rounded shadow-sm focus:ring-blue-500 focus:border-blue-500">
                        </div>
                        <div>
                    ...
                    <p class="text-sm text-gray-500 mb-4">Vul een getal in (bijv. 10 of -20) bij de categorieën die beïnvloed worden. Laat leeg voor geen effect.</p>
